// var game = new Phaser.Game(800, 600, Phaser.AUTO, 'phaser-example', { preload: preload, create: create, render: render, update: update });
//
// function preload() {
//
...
//
//     alert("Though I'm turning around, you can still click on me, WOAH");
//
// }
//
// function update(){
